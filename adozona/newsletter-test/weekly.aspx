...
<head>
	...
	<title>
        <CMSControls:PageLayoutControl ID="PageLayoutControl3" runat="server" PageID="9464" Visible="True" TemplateItemName="pageLayout" IsCachingEnabled="true" CacheSeconds="5" />  
	</title>
	...
	<tr>
		<td style="padding:10px;background:#484848;font-size:0;border-bottom:5px solid #C10000;">
			...
			<tr>
				...
				<td valign="bottom" style="padding:0px;">
					<p style="margin:0;font-size:18px;text-align:right;font-weight:bold;color:#D9D9D9">Heti Szemle</p>
				</td>
			</tr>
			</table>
		    </center>
	...
	<tr>
		<td style="">
			...
			<tr>
                ...
                <%-- Heti hirlevel        --%>
                <CMSControls:PageLayoutControl ID="PageLayoutControl2" runat="server" PageID="7471" Visible="True" TemplateItemName="pageLayout" IsCachingEnabled="true" CacheSeconds="5" />  
			...
			<tr>
				...
				<p style="margin:10px 0;font-size:12px;">Leiratkozáshoz <a style="color:#f5f5f5;text-decoration:none;font-weight:bold;" href="https://kulcs.hvg.hu/nlConf/hirlevel_ado_le/{@sid}{@campaign}" target="_blank">kattintson ide</a>!</p>
...
<script runat="server">
    ...
    {
        ManualNewsletterId = new Guid("2D2F868B-B333-49C7-AD3C-2FBAF232E111");
        AutoNewsletterId = new Guid("06f0075f-41e7-4fe6-97ea-728220967327");
        NewsletterLeadPageItemId = 7471;
