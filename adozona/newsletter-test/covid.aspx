...
<head>
	...
	<title>
        <CMSControls:PageLayoutControl ID="PageLayoutControl3" runat="server" PageID="9467" Visible="True" TemplateItemName="pageLayout" IsCachingEnabled="true" CacheSeconds="5" />  
	</title>
	...
	<tr>
		<td style="padding:10px;background:#484848;font-size:0;border-bottom:5px solid #C10000;">
			...
			<tr>
				...
				<td valign="bottom" style="padding:0px;">
					<p style="margin:0;font-size:18px;text-align:right;font-weight:bold;color:#D9D9D9">Koronavírus: adó, tb, munkajog</p>
				</td>
			</tr>
			</table>
		    </center>
	...
	<tr>
		<td style="">
			...
			<tr>
                ...
                <%-- Koronavírus hírlevél --%>
                <CMSControls:PageLayoutControl ID="PageLayoutControl2" runat="server" PageID="9466" Visible="True" TemplateItemName="pageLayout" IsCachingEnabled="true" CacheSeconds="5" />  
			...
			<tr>
				...
				<p style="margin:10px 0;font-size:12px;">Leiratkozáshoz <a style="color:#f5f5f5;text-decoration:none;font-weight:bold;" href="https://kulcs.hvg.hu/nlConf/adozona_korona_le/{@sid}{@campaign}" target="_blank">kattintson ide</a>!</p>
...
<script runat="server">
    ...
    {
        ManualNewsletterId = new Guid("3774A8F3-9B35-4AA4-B3C2-5A78C15EC919");
        AutoNewsletterId = new Guid("3774A8F3-9B35-4AA4-B3C2-5A78C15EC919");
        NewsletterLeadPageItemId = 9466;
